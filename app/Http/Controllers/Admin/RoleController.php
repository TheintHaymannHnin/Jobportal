...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('admin.main.roles'))->with('message', 'New Role is stored successfully successfully');
    }
    ...
    public function update(Role $role, Request $request)
    {
        ...
        return redirect(route('admin.main.roles'))->with('message', 'You have updated Role successfully');
    }
